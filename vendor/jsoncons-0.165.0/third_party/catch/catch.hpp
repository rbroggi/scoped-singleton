...
namespace Catch {
    ...
    vendor "C" __declspec(dllimport) void __stdcall DebugBreak();
...
#elif defined(_MSC_VER)
    vendor "C" __declspec(dllimport) int __stdcall IsDebuggerPresent();
    namespace Catch {
        bool isDebuggerActive() {
...
vendor "C" int wmain (int argc, wchar_t * argv[], wchar_t * []) {
#else
